//ДЗ строки:
//Задание 1 - вывести счет: строка 200;
//Задание 2 - генерирование препятствия: строка 242;
//Задание 3 - убрать границы поля: строка 129;
...
function move() {
    ...
    //Убираем границы поля задание №3
...
function haveFood(unit) {
    ...
    if (unit_classes.includes('food-unit')) {
        ...
        score++;
    // Выводим счет игроку Задание №1
        document.getElementById('count').innerText = score;
    }

    // Если съели барьер то конец игры
    else if (unit_classes.includes('bomb')) { 
        finishTheGame();
    }
    return check;
}
...
// Задание №2: Бомба создается при четном поедании еды
/**
 * Создание бомбы
 */
function createBomb() {
        ...
        if (!bomb_cell_classes.includes('snake-unit')) {
            ...
            for (var i = 0; i < bomb_cell_classes.length; i++) {
                classesBomb += bomb_cell_classes[i] + ' ';
            }

            bomb_cell.setAttribute('class', classesBomb + 'bomb');
        }
}
